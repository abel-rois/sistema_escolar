                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <img src="<?php echo get_logo() ?>" alt="<?php echo get_sitename(); ?>" class="img-fluid mb-3" style="width: 200px;">
                                      <h1 class="h4 text-gray-900 mb-4"><?php echo sprintf('¡Bienvenido(a) a %s!', get_sitename()) ?></h1>
                                    </div>
